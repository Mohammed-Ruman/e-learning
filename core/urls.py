...
urlpatterns = [
    ...
    path('teacher/students/<str:name>',views.subscribed_students_course,name='student list course'),
    path('teacher/add',views.add_course,name='add course'),
    path('teacher/add/topic/<str:id>',views.add_topic,name='add topic'),
    ...
    path('teacher/delete/topic/<str:id>',views.delete_course_content,name='delete topic'),
